...
//                var dateArrStr = $( "#date" ).val();
//                var parts = dateArrStr.split('/');
//                var dateArr = new Date(parts[2], parts[1]-1, parts[0]);
//                var options={
//                    format: 'dd/mm/yyyy',
//                    todayHighlight: true,
//                    startDate: dateArr,
...
//                var dateDeparStr = $( "#date2" ).val();
//                var parts = dateDeparStr.split('/');
//                var dateDepar = new Date(parts[2], parts[1]-1, parts[0]);
//                var options={
//                    format: 'dd/mm/yyyy',
//                    todayHighlight: true,
//                    startDate: new Date(),
